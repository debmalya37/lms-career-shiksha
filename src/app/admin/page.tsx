  ...
  return (
    <div className="min-h-screen bg-gray-200 p-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <Link href="/admin/invoice" className="bg-blue-950 text-white p-6 rounded-lg shadow-md text-center">
          <h2 className="text-xl font-semibold">Manage invoices</h2>
        </Link>
        <Link href="/admin/admissionData" className="bg-blue-950 text-white p-6 rounded-lg shadow-md text-center">
          <h2 className="text-xl font-semibold">Manage Admission data</h2>
        </Link>
